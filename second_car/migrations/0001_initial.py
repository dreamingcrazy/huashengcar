    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('brande', models.ForeignKey(verbose_name='所属品牌', to='second_car.Brande')),
            ],
            options={
                'verbose_name': '车辆细节',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', primary_key=True, serialize=False, auto_created=True)),
                ('name', models.CharField(verbose_name='车辆类型', max_length=10)),
                ('image', models.ImageField(verbose_name='车辆代表性图片', upload_to='type')),
            ],
            options={
                'verbose_name': '车辆类型',
        ...
        migrations.AddField(
            ...
            name='style',
            field=models.ForeignKey(verbose_name='所属类型', to='second_car.CarStyle'),
        ),
        migrations.AddField(
            model_name='cardetail',
            name='user',
